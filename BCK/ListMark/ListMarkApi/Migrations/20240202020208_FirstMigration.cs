        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dateupdate = table.Column<DateTime>(name: "Date_update", type: "datetime2", nullable: false),
                    Updateby = table.Column<string>(name: "Update_by", type: "nvarchar(max)", nullable: false),
                    Isdeleted = table.Column<bool>(name: "Is_deleted", type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Commonfields", x => x.Id);
                });
